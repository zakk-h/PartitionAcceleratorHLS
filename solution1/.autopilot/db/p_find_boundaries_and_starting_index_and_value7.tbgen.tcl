set moduleName p_find_boundaries_and_starting_index_and_value7
set isTopModule 0
...
set C_modelName {_find_boundaries_and_starting_index_and_value7}
...
set C_modelArgList {
	...
	{ right_bound int 32 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "num_points", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "right_bound", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ right_bound sc_out sc_lv 32 signal 3 } 
	{ projectionToRow sc_in sc_lv 32 signal 4 } 
	{ start_index sc_out sc_lv 32 signal 5 } 
	{ start_value_i sc_in sc_lv 32 signal 6 } 
	{ start_value_o sc_out sc_lv 32 signal 6 } 
	{ i sc_in sc_lv 3 signal 7 } 
	{ lbVal_constprop_i sc_in sc_lv 32 signal 8 } 
	{ lbVal_constprop_o sc_out sc_lv 32 signal 8 } 
	{ rbVal_constprop_i sc_in sc_lv 32 signal 9 } 
	{ rbVal_constprop_o sc_out sc_lv 32 signal 9 } 
	{ ap_clk sc_in sc_logic 1 clock -1 } 
	{ ap_rst sc_in sc_logic 1 reset -1 active_high_sync } 
	{ projectionToRow_ap_vld sc_in sc_logic 1 invld 4 } 
	{ i_ap_vld sc_in sc_logic 1 invld 7 } 
	{ ap_start sc_in sc_logic 1 start -1 } 
	{ left_bound_ap_vld sc_out sc_logic 1 outvld 2 } 
	{ right_bound_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ lbVal_constprop_i_ap_vld sc_in sc_logic 1 invld 8 } 
	{ lbVal_constprop_o_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ rbVal_constprop_i_ap_vld sc_in sc_logic 1 invld 9 } 
	{ rbVal_constprop_o_ap_vld sc_out sc_logic 1 outvld 9 } 
	{ ap_done sc_out sc_logic 1 predone -1 } 
	{ start_index_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ start_value_i_ap_vld sc_in sc_logic 1 invld 6 } 
	{ start_value_o_ap_vld sc_out sc_logic 1 outvld 6 } 
...
set NewPortList {[ 
	{ "name": "num_points_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "num_points", "role": "address0" }} , 
 	...
 	{ "name": "right_bound", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "right_bound", "role": "default" }} , 
 	...
 	{ "name": "right_bound_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "right_bound", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "7", "10", "11", "12"],
		...
		"InputProcess" : [
			{"ID" : "1", "Name" : "p_find_boundaries_and_starting_index_and_value_entry25_U0"},
			{"ID" : "2", "Name" : "p_find_left_and_right_boundaries9_U0"},
			{"ID" : "7", "Name" : "p_find_starting_index_and_value8_U0"}],
		"OutputProcess" : [
			{"ID" : "2", "Name" : "p_find_left_and_right_boundaries9_U0"},
			{"ID" : "7", "Name" : "p_find_starting_index_and_value8_U0"}],
		"Port" : [
			{"Name" : "num_points", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "p_find_starting_index_and_value8_U0", "Port" : "num_points"},
					{"ID" : "2", "SubInstance" : "p_find_left_and_right_boundaries9_U0", "Port" : "num_points"}]},
			{"Name" : "points", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "p_find_starting_index_and_value8_U0", "Port" : "points"},
					{"ID" : "2", "SubInstance" : "p_find_left_and_right_boundaries9_U0", "Port" : "points"}]},
			{"Name" : "left_bound", "Type" : "Vld", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "p_find_left_and_right_boundaries9_U0", "Port" : "left_bound"}]},
			{"Name" : "right_bound", "Type" : "Vld", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "p_find_left_and_right_boundaries9_U0", "Port" : "right_bound"}]},
			{"Name" : "projectionToRow", "Type" : "None", "Direction" : "I"},
			{"Name" : "start_index", "Type" : "Vld", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "p_find_starting_index_and_value8_U0", "Port" : "start_index"}]},
			{"Name" : "start_value", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "p_find_starting_index_and_value8_U0", "Port" : "start_value"}]},
			{"Name" : "i", "Type" : "None", "Direction" : "I"},
			{"Name" : "get_trapezoid_edgestrapezoid_edges", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "p_find_left_and_right_boundaries9_U0", "Port" : "get_trapezoid_edgestrapezoid_edges"}]},
			{"Name" : "lbVal_constprop", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "p_find_left_and_right_boundaries9_U0", "Port" : "lbVal_constprop"}]},
			{"Name" : "rbVal_constprop", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "p_find_left_and_right_boundaries9_U0", "Port" : "rbVal_constprop"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_find_boundaries_and_starting_index_and_value_entry25_U0", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "projectionToRow", "Type" : "None", "Direction" : "I"},
			{"Name" : "i", "Type" : "None", "Direction" : "I"},
			{"Name" : "projectionToRow_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "7", "DependentChan" : "10", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "projectionToRow_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "i_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "2", "DependentChan" : "11", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "i_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "i_out1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "7", "DependentChan" : "12", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "i_out1_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_find_left_and_right_boundaries9_U0", "Parent" : "0", "Child" : ["3", "4", "5", "6"],
		...
		"Port" : [
			...
			{"Name" : "left_bound", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "right_bound", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "i", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "1", "DependentChan" : "11", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "i_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "get_trapezoid_edgestrapezoid_edges", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "lbVal_constprop", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "rbVal_constprop", "Type" : "OVld", "Direction" : "IO"}]},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.p_find_left_and_right_boundaries9_U0.get_trapezoid_edgestrapezoid_edges_U", "Parent" : "2"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.p_find_left_and_right_boundaries9_U0.faddfsub_32ns_32ns_32_3_full_dsp_1_U6", "Parent" : "2"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.p_find_left_and_right_boundaries9_U0.fpext_32ns_64_2_no_dsp_1_U7", "Parent" : "2"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.p_find_left_and_right_boundaries9_U0.fpext_32ns_64_2_no_dsp_1_U8", "Parent" : "2"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_find_starting_index_and_value8_U0", "Parent" : "0", "Child" : ["8", "9"],
		...
		"Port" : [
			{"Name" : "num_points", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "points", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "projectionToRow", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "1", "DependentChan" : "10", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "projectionToRow_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "start_index", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "start_value", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "i", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "1", "DependentChan" : "12", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "i_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.p_find_starting_index_and_value8_U0.fsub_32ns_32ns_32_3_full_dsp_1_U19", "Parent" : "7"},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.p_find_starting_index_and_value8_U0.fcmp_32ns_32ns_1_2_no_dsp_1_U20", "Parent" : "7"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.projectionToRow_c_U", "Parent" : "0"},
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.i_c_U", "Parent" : "0"},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.i_c7_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	right_bound { ap_vld {  { right_bound out_data 1 32 }  { right_bound_ap_vld out_vld 1 1 } } }
	projectionToRow { ap_none {  { projectionToRow in_data 0 32 }  { projectionToRow_ap_vld in_vld 0 1 } } }
