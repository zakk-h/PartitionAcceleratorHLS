set moduleName p_find_starting_index_and_value8
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "num_points", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "projectionToRow", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ projectionToRow_dout sc_in sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "projectionToRow_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "projectionToRow", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fsub_32ns_32ns_32_3_full_dsp_1_U19", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	projectionToRow { ap_fifo {  { projectionToRow_dout fifo_data 0 32 }  { projectionToRow_empty_n fifo_status 0 1 }  { projectionToRow_read fifo_update 1 1 } } }
