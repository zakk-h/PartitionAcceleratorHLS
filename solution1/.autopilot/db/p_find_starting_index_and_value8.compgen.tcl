...
set id 19
set name system_top_fsub_32ns_32ns_32_3_full_dsp_1
...
set id 20
set name system_top_fcmp_32ns_32ns_1_2_no_dsp_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename num_points \
    op interface \
    ports { num_points_address1 { O 3 vector } num_points_ce1 { O 1 bit } num_points_q1 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename points \
    op interface \
    ports { points_address1 { O 12 vector } points_ce1 { O 1 bit } points_q1 { I 128 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { projectionToRow_dout { I 32 vector } projectionToRow_empty_n { I 1 bit } projectionToRow_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { start_value_i { I 32 vector } start_value_o { O 32 vector } start_value_o_ap_vld { O 1 bit } } \
} "
}
