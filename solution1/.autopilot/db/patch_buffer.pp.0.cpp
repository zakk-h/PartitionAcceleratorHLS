# 1 "PartitionAcceleratorHLS/src/patch_buffer.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "PartitionAcceleratorHLS/src/patch_buffer.cpp" 2
# 1 "PartitionAcceleratorHLS/include\\patch_buffer.h" 1


# 1 "PartitionAcceleratorHLS/include/config.h" 1
# 4 "PartitionAcceleratorHLS/include\\patch_buffer.h" 2

# 1 "PartitionAcceleratorHLS/include/types.h" 1
...
# 6 "PartitionAcceleratorHLS/include/types.h" 2
...
typedef ap_fixed<32, 12> z_value_t;




typedef ap_fixed<32, 12> radius_value_t;




typedef ap_fixed<32, 12> phi_value_t;




typedef ap_fixed<32, 12> float_value_t;

typedef ap_int<32> int_value_t;

typedef ap_uint<32 + 32 + 32> point_t;
...
typedef struct {
  point_t points[5][512];
} PointArr5x16_t;
# 82 "PartitionAcceleratorHLS/include/types.h"
constexpr float get_trapezoid_edges(int idx) {
  float trapezoid_edges[5] = {22.0001, 29.0001, 36.0001, 43.0001,
                                       50.0001};
...
constexpr float get_parallelogram_slopes(int idx) {
  float parallelogram_slopes[5 - 1] = {0, -(float)(1.0 / 3.0), -1, -3};

  return parallelogram_slopes[idx];
}

constexpr int get_radii(int idx) {
  int radii[5] = {5, 10, 15, 20, 25};

  return radii[idx];
}

constexpr float get_radii_leverArm(int idx) {
  float radii_leverArm[5 - 1] = {1, 1.0 + 1.0 / 3.0, 2, 4};

  return radii_leverArm[idx];
}
# 6 "PartitionAcceleratorHLS/include/patch_buffer.h" 2

# 1 "C:/Xilinx/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\6.2.0\\include\\c++\\cstring" 1 3
# 40 "C:/Xilinx/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\6.2.0\\include\\c++\\cstring" 3
...
# 42 "C:/Xilinx/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\6.2.0\\include\\c++\\cstring" 2 3
...
#pragma pack(pop)
# 10 "C:/Xilinx/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\string.h" 2 3
...
# 43 "C:/Xilinx/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\6.2.0\\include\\c++\\cstring" 2 3
# 71 "C:/Xilinx/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\6.2.0\\include\\c++\\cstring" 3
namespace std
{
...
# 8 "PartitionAcceleratorHLS/include/patch_buffer.h" 2
...
# 9 "PartitionAcceleratorHLS/include/patch_buffer.h" 2
...
void patch_buffer_add_patch(
    point_t new_patch[5][16],
    point_t patch_buffer[3][5]
                        [16],
...
void read_patch_stream(hls::stream<point_t> &patch_stream,
                       point_t patch[5][16]);
# 2 "PartitionAcceleratorHLS/src/patch_buffer.cpp" 2



# 1 "C:/Xilinx/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\6.2.0\\include\\c++\\cstring" 1 3
# 40 "C:/Xilinx/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\6.2.0\\include\\c++\\cstring" 3
# 6 "PartitionAcceleratorHLS/src/patch_buffer.cpp" 2
...
void patch_buffer_add_patch(
  ...
  latest_patch_index = (latest_patch_index + 1) % 3;
  num_patches++;


loop_copy_patch_buffer_layer:
  for (index_t layer = 0; layer < 5; layer++) {
#pragma HLS UNROLL
 loop_copy_patch_buffer_superpoint:
    for (index_t point = 0; point < 16; point++) {
#pragma HLS UNROLL
