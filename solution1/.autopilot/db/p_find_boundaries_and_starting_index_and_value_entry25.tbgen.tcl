...
set C_modelArgList {
	...
	{ i int 3 regular  }
	{ projectionToRow_out int 32 regular {fifo 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "projectionToRow", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "projectionToRow_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ projectionToRow sc_in sc_lv 32 signal 0 } 
	{ i sc_in sc_lv 3 signal 1 } 
	{ projectionToRow_out_din sc_out sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "projectionToRow_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "projectionToRow_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	projectionToRow_out { ap_fifo {  { projectionToRow_out_din fifo_data 1 32 }  { projectionToRow_out_full_n fifo_status 0 1 }  { projectionToRow_out_write fifo_update 1 1 } } }
