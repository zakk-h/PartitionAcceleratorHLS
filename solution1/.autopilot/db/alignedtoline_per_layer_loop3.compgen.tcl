...
set id 43
set name system_top_mul_33s_25ns_58_1_1
...
set id 44
set name system_top_mul_78s_108ns_185_1_1
set corename simcore_mul
set op mul
set stage_num 1
set max_latency -1
...
set ID 48
set hasByteEnable 0
set MemName system_top_alignedtoline_per_layer_loop3_get_radiiradii
...
set TrueReset 0
set IsROM 1
set ROMData { "00000000000000000000000000000101" "00000000000000000000000000001010" "00000000000000000000000000001111" "00000000000000000000000000010100" "00000000000000000000000000011001" }
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename init_patch \
    op interface \
    ports { init_patch_address0 { O 7 vector } init_patch_ce0 { O 1 bit } init_patch_we0 { O 1 bit } init_patch_d0 { O 96 vector } init_patch_address1 { O 7 vector } init_patch_ce1 { O 1 bit } init_patch_we1 { O 1 bit } init_patch_d1 { O 96 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_i_offset \
    op interface \
    ports { i_offset { I 3 vector } } \
} "
}
