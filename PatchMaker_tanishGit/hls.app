<project xmlns="com.autoesl.autopilot.project" name="PatchMaker_tanishGit" top="makePatches_ShadowQuilt_fromEdges">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
    ...
    <files xmlns="">
        <file name="../../wedgeData_v3_128.txt" sc="0" tb="1" cflags=" -Wno-unknown-pragmas" csimflags=" -Wno-unknown-pragmas" blackbox="false"/>
