...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "makePatches_ShadowQuilt_fromEdges.autotvin.dat"
	set constFileTvOut       "makePatches_ShadowQuilt_fromEdges.autotvout.dat"
	set constFileHdlTvIn     "makePatches_ShadowQuilt_fromEdges.autohdltvin.dat"
	set constFileHdlTvOut    "makePatches_ShadowQuilt_fromEdges.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
