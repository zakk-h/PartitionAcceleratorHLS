...
set id 1
set name makePatches_ShadowQuilt_fromEdges_fadd_32ns_32ns_32_3_full_dsp_1
...
set id 2
set name makePatches_ShadowQuilt_fromEdges_fmul_32ns_32ns_32_2_max_dsp_1
...
set id 3
set name makePatches_ShadowQuilt_fromEdges_fdiv_32ns_32ns_32_6_no_dsp_1
...
set id 4
set name makePatches_ShadowQuilt_fromEdges_sitofp_64ns_32_2_no_dsp_1
...
set id 7
set name makePatches_ShadowQuilt_fromEdges_dcmp_64ns_64ns_1_2_no_dsp_1
...
set id 8
set name makePatches_ShadowQuilt_fromEdges_sitodp_64ns_64_2_no_dsp_1
...
set id 10
set name makePatches_ShadowQuilt_fromEdges_mul_64ns_66ns_129_1_1
...
set id 11
set name makePatches_ShadowQuilt_fromEdges_mul_64ns_3ns_66_1_1
set corename simcore_mul
set op mul
set stage_num 1
set max_latency -1
...
set TrueReset 0
set IsROM 1
set ROMData { "01010011111011000111100100" "01101110101000000110100100" "10001001010101000101100100" "10100100000010000100100100" "10111110101111000011100100" }
set HasInitializer 1
set Initializer $ROMData
set NumOfStage 2
set MaxLatency -1
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_original_ppl \
    op interface \
    ports { original_ppl { I 32 vector } } \
} "
}
