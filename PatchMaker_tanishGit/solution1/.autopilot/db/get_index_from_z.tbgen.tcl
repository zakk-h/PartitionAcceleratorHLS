...
set C_modelArgMapList {[ 
	{ "Name" : "GDarray", "interface" : "memory", "bitwidth" : 192, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "z_value", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ z_value sc_in sc_lv 64 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "z_value", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "z_value", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	z_value { ap_none {  { z_value in_data 0 64 } } }
}
