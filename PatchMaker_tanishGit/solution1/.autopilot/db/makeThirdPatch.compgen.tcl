...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { patches_superpoints_address0 { O 15 vector } patches_superpoints_ce0 { O 1 bit } patches_superpoints_we0 { O 1 bit } patches_superpoints_d0 { O 64 vector } patches_superpoints_q0 { I 64 vector } patches_superpoints_address1 { O 15 vector } patches_superpoints_ce1 { O 1 bit } patches_superpoints_q1 { I 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { patches_parameters_address0 { O 12 vector } patches_parameters_ce0 { O 1 bit } patches_parameters_we0 { O 1 bit } patches_parameters_d0 { O 64 vector } patches_parameters_q0 { I 64 vector } patches_parameters_address1 { O 12 vector } patches_parameters_ce1 { O 1 bit } patches_parameters_we1 { O 1 bit } patches_parameters_d1 { O 64 vector } patches_parameters_q1 { I 64 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { lastPatchIndex { I 5 vector } } \
} "
}
