...
set C_modelArgList {
	...
	{ patches_superpoints int 64 regular {array 23040 { 0 1 } 1 1 }  }
	{ patches_parameters int 64 regular {array 3840 { 0 1 } 1 1 }  }
...
set portList { 
	...
	{ patches_superpoints_address1 sc_out sc_lv 15 signal 2 } 
	...
	{ patches_parameters_address1 sc_out sc_lv 12 signal 3 } 
	{ patches_parameters_ce1 sc_out sc_logic 1 signal 3 } 
	{ patches_parameters_q1 sc_in sc_lv 64 signal 3 } 
	{ index sc_in sc_lv 32 signal 4 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_15s_11ns_15_4_1_U91", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	patches_superpoints { ap_memory {  { patches_superpoints_address0 mem_address 1 15 }  { patches_superpoints_ce0 mem_ce 1 1 }  { patches_superpoints_we0 mem_we 1 1 }  { patches_superpoints_d0 mem_din 1 64 }  { patches_superpoints_address1 MemPortADDR2 1 15 }  { patches_superpoints_ce1 MemPortCE2 1 1 }  { patches_superpoints_q1 MemPortDOUT2 0 64 } } }
	patches_parameters { ap_memory {  { patches_parameters_address0 mem_address 1 12 }  { patches_parameters_ce0 mem_ce 1 1 }  { patches_parameters_we0 mem_we 1 1 }  { patches_parameters_d0 mem_din 1 64 }  { patches_parameters_address1 MemPortADDR2 1 12 }  { patches_parameters_ce1 MemPortCE2 1 1 }  { patches_parameters_q1 MemPortDOUT2 0 64 } } }
