...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name makePatches_ShadowQuilt_fromEdges_ap_fdiv_4_no_dsp_32
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Single \
                          ...
                          CONFIG.component_name makePatches_ShadowQuilt_fromEdges_ap_fdiv_4_no_dsp_32 \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips makePatches_ShadowQuilt_fromEdges_ap_fdiv_4_no_dsp_32] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files makePatches_ShadowQuilt_fromEdges_ap_fdiv_4_no_dsp_32.xci]
generate_target {synthesis simulation} [get_files makePatches_ShadowQuilt_fromEdges_ap_fdiv_4_no_dsp_32.xci]
