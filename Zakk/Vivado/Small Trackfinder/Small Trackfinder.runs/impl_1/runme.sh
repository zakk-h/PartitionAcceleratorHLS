...
HD_PWD='C:/Users/zakkh/Dark_Matter/PartitionAcceleratorHLS/Zakk/Vivado/Small Trackfinder/Small Trackfinder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log laplacianCalculator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source laplacianCalculator.tcl -notrace
