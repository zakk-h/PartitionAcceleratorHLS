...
HD_PWD='C:/Users/zakkh/Dark_Matter/PartitionAcceleratorHLS/Zakk/Vivado/Small Trackfinder/Small Trackfinder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log laplacianCalculator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source laplacianCalculator.tcl
