...
attribute shreg_extract : string;
    signal icmp_ln710_fu_38_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln710_1_fu_44_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln710_fu_50_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    and_ln710_fu_50_p2 <= (icmp_ln710_fu_38_p2 and icmp_ln710_1_fu_44_p2);
    ap_ready <= ap_const_logic_1;
    ap_return <= (icmp_ln886_fu_32_p2 and and_ln710_fu_50_p2);
    icmp_ln710_1_fu_44_p2 <= "1" when (signed(projectionOfCornerToBeam) < signed(ap_const_lv32_E4E1C0)) else "0";
    icmp_ln710_fu_38_p2 <= "1" when (signed(nPatchesInColumn) < signed(ap_const_lv32_5F5E100)) else "0";
