...
HD_PWD='C:/Users/zakkh/Dark_Matter/PartitionAcceleratorHLS/tanish_v2_no_float/tanish_v2_no_float.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MPSQ.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MPSQ.tcl -notrace
