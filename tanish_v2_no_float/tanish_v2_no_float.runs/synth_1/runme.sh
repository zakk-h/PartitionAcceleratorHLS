...
HD_PWD='C:/Users/zakkh/Dark_Matter/PartitionAcceleratorHLS/tanish_v2_no_float/tanish_v2_no_float.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MPSQ.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MPSQ.tcl
