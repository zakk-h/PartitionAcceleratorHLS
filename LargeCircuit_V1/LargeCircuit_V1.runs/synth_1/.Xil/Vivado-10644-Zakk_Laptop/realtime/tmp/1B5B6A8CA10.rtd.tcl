...
set genomeRtd $env(RT_TMP)/1B5B6A8CA10.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {MPSQ_solveNextColumn__GCB7}]"
...
set genomeName [subst -nocommands -novariables {MPSQ_solveNextColumn__GCB7}]
