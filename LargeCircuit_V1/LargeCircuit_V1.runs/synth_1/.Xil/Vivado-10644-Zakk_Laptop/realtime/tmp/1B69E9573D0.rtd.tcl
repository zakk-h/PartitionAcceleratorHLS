...
set genomeRtd $env(RT_TMP)/1B69E9573D0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {MPSQ_solveNextPatchPair__GCB2}]"
...
set genomeName [subst -nocommands -novariables {MPSQ_solveNextPatchPair__GCB2}]
