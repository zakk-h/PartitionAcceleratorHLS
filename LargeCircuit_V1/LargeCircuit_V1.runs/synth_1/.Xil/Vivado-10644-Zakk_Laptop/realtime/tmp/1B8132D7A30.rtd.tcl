...
set genomeRtd $env(RT_TMP)/1B8132D7A30.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {MPSQ_makeThirdPatch__GCB16}]"
...
set genomeName [subst -nocommands -novariables {MPSQ_makeThirdPatch__GCB16}]
