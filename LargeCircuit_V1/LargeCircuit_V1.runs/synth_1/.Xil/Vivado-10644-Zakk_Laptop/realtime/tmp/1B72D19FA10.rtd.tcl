...
set genomeRtd $env(RT_TMP)/1B72D19FA10.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {MPSQ_delete_patch__GBM3}]"
...
set genomeName [subst -nocommands -novariables {MPSQ_delete_patch__GBM3}]
