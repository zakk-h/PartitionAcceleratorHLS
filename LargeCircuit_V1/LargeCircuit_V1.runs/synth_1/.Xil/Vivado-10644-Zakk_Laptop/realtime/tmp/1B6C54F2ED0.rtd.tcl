...
set genomeRtd $env(RT_TMP)/1B6C54F2ED0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {MPSQ_delete_patch__GBM6}]"
...
set genomeName [subst -nocommands -novariables {MPSQ_delete_patch__GBM6}]
