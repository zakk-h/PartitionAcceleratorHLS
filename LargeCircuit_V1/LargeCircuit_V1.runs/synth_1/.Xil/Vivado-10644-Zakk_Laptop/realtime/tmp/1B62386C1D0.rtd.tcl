...
set genomeRtd $env(RT_TMP)/1B62386C1D0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {MPSQ_minValFinder__GBM3}]"
...
set genomeName [subst -nocommands -novariables {MPSQ_minValFinder__GBM3}]
