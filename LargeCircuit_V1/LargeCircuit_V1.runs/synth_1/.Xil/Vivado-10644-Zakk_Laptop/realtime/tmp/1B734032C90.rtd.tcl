...
set genomeRtd $env(RT_TMP)/1B734032C90.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {MPSQ_solveNextColumn__GCB4}]"
...
set genomeName [subst -nocommands -novariables {MPSQ_solveNextColumn__GCB4}]
