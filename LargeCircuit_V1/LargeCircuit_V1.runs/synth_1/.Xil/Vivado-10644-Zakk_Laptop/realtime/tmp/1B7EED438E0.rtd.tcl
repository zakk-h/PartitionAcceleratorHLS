...
set genomeRtd $env(RT_TMP)/1B7EED438E0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {MPSQ_get_index_from_z__GCBM4__3}]"
...
set genomeName [subst -nocommands -novariables {MPSQ_get_index_from_z__GCBM4__3}]
