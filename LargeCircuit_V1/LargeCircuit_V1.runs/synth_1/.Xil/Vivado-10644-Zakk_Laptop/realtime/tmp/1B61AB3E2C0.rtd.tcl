...
set genomeRtd $env(RT_TMP)/1B61AB3E2C0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {MPSQ_minValFinder__GBM2}]"
...
set genomeName [subst -nocommands -novariables {MPSQ_minValFinder__GBM2}]
