...
set genomeRtd $env(RT_TMP)/1B6C9C2F970.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {MPSQ__GCB4}]"
...
set genomeName [subst -nocommands -novariables {MPSQ__GCB4}]
