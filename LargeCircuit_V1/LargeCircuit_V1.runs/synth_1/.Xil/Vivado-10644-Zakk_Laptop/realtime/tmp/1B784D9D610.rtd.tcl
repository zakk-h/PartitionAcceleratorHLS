...
set genomeRtd $env(RT_TMP)/1B784D9D610.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {MPSQ_solveComplmentaryPatch__GCB11}]"
...
set genomeName [subst -nocommands -novariables {MPSQ_solveComplmentaryPatch__GCB11}]
