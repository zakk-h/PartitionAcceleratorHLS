...
HD_PWD='C:/Users/zakkh/Dark_Matter/PartitionAcceleratorHLS/tanish_vivado/tanish_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log makePatches_ShadowQuilt_fromEdges.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source makePatches_ShadowQuilt_fromEdges.tcl
